...
STAR --runMode alignReads --runThreadN ${cpu_num} --genomeDir ${hg38_refdir} --readFilesCommand zcat --readFilesIn ${R1} ${R2} --outSAMtype BAM SortedByCoordinate --outFileNamePrefix ${sample} --sjdbOverhang 100 --outFilterScoreMinOverLread 0.3 --outFilterMatchNminOverLread 0.3 --outFilterMatchNmin 0 --outFilterMismatchNmax 1
echo "STAR --runMode alignReads --runThreadN ${cpu_num} --genomeDir ${hg38_refdir} --readFilesCommand zcat --readFilesIn ${R1} ${R2} --outSAMtype BAM SortedByCoordinate --outFileNamePrefix ${sample} --sjdbOverhang 100 --outFilterScoreMinOverLread 0.3 --outFilterMatchNminOverLread 0.3 --outFilterMatchNmin 0 --outFilterMismatchNmax 1"
